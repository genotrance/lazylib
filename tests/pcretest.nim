...
proc compile*(pattern: cstring,
              ...
              errptr: ptr cstring,
              erroffset: ptr cint,
              tableptr: pointer): ptr Pcre {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc config*(what: cint,
             where: pointer): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc copy_named_substring*(code: ptr Pcre,
                           ...
                           stringname: cstring,
                           buffer: cstring,
                           buffersize: cint): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc dfa_exec*(code: ptr Pcre,
               ...
               ovecsize: cint,
               workspace: ptr cint,
               wscount: cint): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc exec*(code: ptr Pcre,
           ...
           options: cint,
           ovector: ptr cint,
           ovecsize: cint): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc jit_exec*(code: ptr Pcre,
               ...
               ovector: ptr cint,
               ovecsize: cint,
               jstack: ptr JitStack): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc free_substring*(stringptr: cstring) {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc free_substring_list*(stringptr: cstringArray) {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc get_named_substring*(code: ptr Pcre,
                          ...
                          stringcount: cint,
                          stringname: cstring,
                          stringptr: cstringArray): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc get_stringnumber*(code: ptr Pcre,
                       name: cstring): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc get_stringtable_entries*(code: ptr Pcre,
                              name: cstring,
                              first: cstringArray,
                              last: cstringArray): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
...
proc get_substring_list*(subject: cstring,
                         ovector: ptr cint,
                         stringcount: cint,
                         listptr: ptr cstringArray): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc maketables*(): pointer {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc refcount*(code: ptr Pcre,
               adjust: cint): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc study*(code: ptr Pcre,
            options: cint,
            errptr: ptr cstring): ptr ExtraData {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc free_study*(extra: ptr ExtraData) {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc version*(): cstring {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

# Utility functions for byte order swaps.

proc pattern_to_host_byte_order*(code: ptr Pcre,
                                 extra: ptr ExtraData,
                                 tables: pointer): cint {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

# JIT compiler related functions.

proc jit_stack_alloc*(startsize: cint,
                      maxsize: cint): ptr JitStack {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc jit_stack_free*(stack: ptr JitStack) {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc assign_jit_stack*(extra: ptr ExtraData,
                       callback: JitCallback,
                       data: pointer) {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}

proc jit_free_unused_memory*() {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}


# There was an odd function with `var cstring` instead of `ptr`
proc study*(code: ptr Pcre,
            options: cint,
            errptr: var cstring): ptr ExtraData {.lazylib: pcreDll, cdecl, importc: "pcre_$1".}
